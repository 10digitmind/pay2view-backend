 ...
 async function sendPaymentAlertToCreator(userEmail, creatorName, contentTitle,amount,dashboardUrl) {
     const transporter = await createTransporter();
 ...
 async function sendPaymentAlertToBuyer(buyerEmail, buyerName, contentTitle,contentUrl,) {
     const transporter = await createTransporter();
 ...
 async function sendWithdrawalEmail(accountName, bankName, accountNumber,amount,userEmail) {
     const transporter = await createTransporter();
...
module.exports = {sendVerificationEmail,sendPasswordResetEmail,sendPaymentAlertToCreator,sendPaymentAlertToBuyer,sendWithdrawalEmail} 
